...
export interface MegaProduct {
  ...
  costPerPalletMinor: number // production cost — drives the owner's expected purchase-cost calendar
}
export const megaCatalog: MegaProduct[] = [
  { sku: 'PLT-ASSORTED', name: { en: 'Assorted bar pallet', ar: 'طبلية ألواح مشكّلة' }, category: { en: 'Retail pallets', ar: 'طبليات تجزئة' }, pricePerPalletMinor: 1100000, cbm: 1.2, grossKg: 480, unitsPerPallet: 1800, moq: 3, costPerPalletMinor: 700000, color: '#365766' },
  { sku: 'PLT-SEASON', name: { en: 'Seasonal assortment pallet', ar: 'طبلية تشكيلة موسمية' }, category: { en: 'Retail pallets', ar: 'طبليات تجزئة' }, pricePerPalletMinor: 1400000, cbm: 1.4, grossKg: 520, unitsPerPallet: 1600, moq: 3, costPerPalletMinor: 880000, color: '#8e2f55', country: 'ae' },
  { sku: 'PLT-GIFTBOX', name: { en: 'Luxury gift-box pallet', ar: 'طبلية بوكسات فاخرة' }, category: { en: 'Retail pallets', ar: 'طبليات تجزئة' }, pricePerPalletMinor: 2050000, cbm: 1.5, grossKg: 440, unitsPerPallet: 720, moq: 2, costPerPalletMinor: 1250000, color: '#b5403b' },
  { sku: 'PLT-DATES', name: { en: 'Chocolate-dates pallet (KSA)', ar: 'طبلية تمور بالشوكولاتة (السعودية)' }, category: { en: 'Retail pallets', ar: 'طبليات تجزئة' }, pricePerPalletMinor: 1750000, cbm: 1.3, grossKg: 500, unitsPerPallet: 1200, moq: 2, costPerPalletMinor: 1050000, color: '#7a5230', country: 'sa' },
  { sku: 'BULK-COUVERTURE', name: { en: 'Bulk couverture (ton)', ar: 'كوفرتور خام (طن)' }, category: { en: 'Raw by ton', ar: 'خام بالطن' }, pricePerPalletMinor: 2160000, cbm: 1.0, grossKg: 1000, unitsPerPallet: 1, moq: 1, costPerPalletMinor: 1400000, color: '#3b241a' },
