...
const baseSeed: Record<ProdChannel, Omit<StoreProduct, 'variants'>[]> = {
  b2c: [
    { id: 'sp-b2c-1', name: { en: 'Dark 70% bar', ar: 'لوح داكن ٧٠٪' }, desc: { en: 'Single-origin Jazan cacao, slow-conched to a clean snap.', ar: 'كاكاو جازان أحادي المصدر، مُملّس ببطء حتى قرمشة نقية.' }, category: CAT.bars, priceMinor: 4400, color: '#2e1a10', badges: ['bestseller'], visible: true },
    { id: 'sp-b2c-2', name: { en: 'Milk & jasmine bar', ar: 'لوح حليب بالفُل' }, desc: { en: 'Silky milk chocolate lifted with Taif jasmine.', ar: 'شوكولاتة حليب حريرية بلمسة فُل الطائف.' }, category: CAT.bars, priceMinor: 3800, color: '#6b4a2e', badges: [], visible: true },
    { id: 'sp-b2c-3', name: { en: 'Pistachio & date bar', ar: 'لوح فستق وتمر' }, desc: { en: 'Roasted pistachio and Madinah dates folded in milk.', ar: 'فستق محمّص وتمر المدينة في شوكولاتة الحليب.' }, category: CAT.bars, priceMinor: 4600, color: '#6b7a4a', badges: ['new'], visible: true },
